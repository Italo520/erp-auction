...
export const Sidebar: React.FC<SidebarProps> = ({ className, isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    "flex flex-col h-screen w-64 bg-white dark:bg-[#111722] border-r border-slate-200 dark:border-slate-800 fixed left-0 top-0 z-40 transition-transform duration-300 lg:translate-x-0",
