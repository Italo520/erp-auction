...
export default function Login() {
  ...
  return (
    <div className="flex flex-1 justify-center py-5 md:py-10 px-4 min-h-screen bg-background-light dark:bg-background-dark overflow-y-auto">
            ...
            <form className="flex flex-col gap-5 p-6 md:p-8" onSubmit={handleLogin}>
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input className="flex w-full min-w-0 resize-none overflow-hidden rounded-lg text-[#111418] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#d1d5db] dark:border-[#324467] bg-white dark:bg-[#111722] focus:border-primary h-12 md:h-14 placeholder:text-[#92a4c9] pl-12 pr-4 text-base font-normal leading-normal transition-all" placeholder="exemplo@email.com" type="email" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input className="flex w-full min-w-0 resize-none overflow-hidden rounded-lg text-[#111418] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#d1d5db] dark:border-[#324467] bg-white dark:bg-[#111722] focus:border-primary h-12 md:h-14 placeholder:text-[#92a4c9] pl-12 pr-12 text-base font-normal leading-normal transition-all" placeholder="••••••••" type="password" />
              ...
              <button className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 md:h-14 bg-primary hover:bg-primary/90 text-white text-base font-bold leading-normal tracking-[0.015em] transition-colors shadow-lg shadow-primary/20 mt-2">
